        <div class="row">
          <div class="col s12 m9">
            <h3 class="grey-text">Masyarakat</h3>
          </div>  
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn teal modal-trigger" href="#regis_edit?nik=<?php echo $r['nik'] ?>">Edit</a> <a onclick="return confirm('Anda Yakin Ingin Menghapus Pengguna Tersebut')" class="btn red" href="index.php?p=regis_hapus&nik=<?php echo $r['nik'] ?>">Hapus</a></td>
