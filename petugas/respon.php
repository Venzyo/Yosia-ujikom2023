	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn blue modal-trigger" href="#more?id_tanggapan=<?php echo $r['id_tanggapan'] ?>">Lihat Respon</a> <a class="btn red" onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" href="index.php?p=tanggapan_hapus&id_tanggapan=<?php echo $r['id_tanggapan'] ?>">Hapus</a></td>
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
        ...
        <div id="more?id_tanggapan=<?php echo $r['id_tanggapan'] ?>" class="modal">
          ...
          <div class="modal-footer col s12">
            <a href="#!" class="card red white-text modal-close waves-effect waves-green btn-flat">Kembali</a>
          </div>
        </div>
<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
